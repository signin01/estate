                  ...
                  >
                    ...
                    <div style={{ padding: '20px', textAlign: 'left' }}>
                      ...
                      <div style={{ display: 'flex', gap: '10px', marginTop: '15px' }}>
                        <button onClick={(e) => { e.stopPropagation(); alert('Added to wishlist!'); }} style={{ padding: '8px', backgroundColor: '#ff6b6b', color: 'white', border: 'none', borderRadius: '5px', cursor: 'pointer', flex: 1 }}>Wishlist</button>
